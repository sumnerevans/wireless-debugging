Going from the web interface to the web app backend, there is a single websocket message that is sent which is used to associate a user to the sent web socket. 
