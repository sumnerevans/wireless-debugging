...
class UserManagementInterfaceBase:
    """The user management inferface definition
        ...
        The set of necessary function a user needs to implement in order
    ...
    def get_login_ui(self, base_url):
        ...
        Returns:
            String, contains the HTML for the login UI.
            This HTML should inlude an HTML form which posts to the login URL.
        """ 
    ...
    def handle_login(self, form_data, request, response):
        ...
        Args:
            form_data: Dict/Bottle form object, 
                the form data from the form generated by get_login_ui 
            request: An HTTP request context from Bottle
        ...
        Returns: 
            A tuple containing:
                ...
                error_message: String, 
                    returns a message describing why the login failed 
