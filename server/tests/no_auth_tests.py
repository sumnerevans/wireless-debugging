"""
Tests the no authorization impleentation of the user management interface class
...
def test_get_login():
    """ Verify that the login UI doesn't exist,
        and that a blank HTML page is returned.
    """
    umi = no_auth.NoAuth()
...
def test_find_websockets():
    """ The only sort of non-trivial test, 
        Verifies that find_associated_websockets says to broadcast to all 
